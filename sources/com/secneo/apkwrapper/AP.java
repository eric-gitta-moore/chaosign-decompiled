...
public final class AP extends AppComponentFactory {
    ...
    private static boolean a() {
        try {
            int[] iArr = new int[0];
            return Boolean.parseBoolean(AW.validACF) && !"androidx.core.app.CoreComponentFactory".equals(H.ACFNAME) && !"android.app.AppComponentFactory".equals(H.ACFNAME) && !"android.support.v4.app.CoreComponentFactory".equals(H.ACFNAME);
        } catch (Exception ex1) {
            throw ex1;
        }
    }
